...
public static class PermissionSeeder
{
    ...
    [
        ...
        ("create_orders", "Create room service orders"),
        ("update_orders", "Update room service orders"),
        ("resolve_maintenance", "Resolve maintenance issues"),
        ("assign_maintenance", "Assign maintenance technicians"),
